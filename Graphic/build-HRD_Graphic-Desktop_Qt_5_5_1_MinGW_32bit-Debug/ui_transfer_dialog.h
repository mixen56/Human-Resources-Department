...
public:
    ...
    void setupUi(QWidget *Transfer_dialog)
    {
        ...
        Transfer_dialog->setMaximumSize(QSize(616, 284));
        Transfer_dialog->setStyleSheet(QLatin1String("background: url(:/resources/img/unit.png) no-repeat;\n"
"background-size: cover\n"
"\n"
"\n"
""));
        widget = new QWidget(Transfer_dialog);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(0, 10, 615, 271));
        verticalLayout = new QVBoxLayout(widget);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        label_choose_chipher = new QLabel(widget);
        ...
        combo_chipher_first = new QComboBox(widget);
        ...
        radio_create_unit = new QRadioButton(widget);
        ...
        radio_not_create_unit = new QRadioButton(widget);
        ...
        check_change_type = new QCheckBox(widget);
        ...
        label_aim_unit = new QLabel(widget);
        ...
        combo_aim_unit = new QComboBox(widget);
        ...
        label_new_unit = new QLabel(widget);
        ...
        line_new_unit = new QLineEdit(widget);
        ...
        label_new_chief = new QLabel(widget);
        ...
        combo_new_chief = new QComboBox(widget);
        ...
        label_aim_new_chief = new QLabel(widget);
        ...
        combo_aim_new_chief = new QComboBox(widget);
        ...
        Transfer = new QPushButton(widget);
        ...
        push_cancel = new QPushButton(widget);
